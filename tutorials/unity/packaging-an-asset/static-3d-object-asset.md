...
![Created empty 'FRS' object](<../../../.gitbook/assets/image (25).png>)

Make sure the orientation is (0,0,0), location is (0,0,0), and scale is (1,1,1)

![FRS's default location, orientation, and scale](<../../../.gitbook/assets/image (17).png>)

Drag the SCI\_FRS\_13\_HD inside the FRS game object.

![Set FRS to the parent of SCI\_FRS\_13\_HD object](<../../../.gitbook/assets/image (4).png>)
...
![Drag the object to the project folder to create a prefab](<../../../.gitbook/assets/image (24).png>)

#### 4. Set the Prefab's AssetBundle

In the bottom of the Inspector, set the Assetbundle name. In this case, we set it to "frs"

![Set Asset Bundle name](<../../../.gitbook/assets/image (13).png>)
